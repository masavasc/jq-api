...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ csv, count: rows.length, note: "first pass: prices only; fundamentals placeholders" });
  } catch (e: any) {
